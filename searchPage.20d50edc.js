...
},{"qs":"../node_modules/qs/lib/index.js","axios":"../node_modules/axios/index.js","buffer":"../node_modules/buffer/index.js"}],"js/asset/setBreadArray.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setBreadArray = setBreadArray;

function setBreadArray() {
  var themeList = {
    ScenicSpot: '探索景點',
    Activity: '節慶活動',
    Restaurant: '品嚐美食'
...
},{}],"js/asset/location.js":[function(require,module,exports) {
"use strict";
...
},{"./location":"js/asset/location.js"}],"js/components/header.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"js/asset/getData.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../node_modules/axios/index.js"}],"js/asset/changeSelection.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../asset/getData":"js/asset/getData.js","../asset/changeSelection":"js/asset/changeSelection.js","../asset/getToken":"js/asset/getToken.js","../asset/location":"js/asset/location.js"}],"js/components/breadcrumb.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"js/asset/cardEvent.js":[function(require,module,exports) {
"use strict";
...
},{"./getToken":"js/asset/getToken.js","./getData":"js/asset/getData.js"}],"js/components/pagination.js":[function(require,module,exports) {
"use strict";
...
function renderPages(data) {
  ...
  pageData.allData = data; //總頁籤數

  var rows = Math.ceil(pageData.allData.length / pageData.pageItems); //創建過度按鈕

  var transition = $('<li/>', {
    class: 'page-item transition-item-js'
  }).append($('<a/>', {
    class: 'page-link link-secondary disabled',
    href: 'javascript:;',
    text: '...'
  }));
  var transition2 = transition.clone(); //創建第1頁和最後頁按鈕
  ...
  var lastItem = $('<li/>', {
    class: 'page-item  lastPage-js'
  }).append(lastALink);
  $('.pagination').children('.page-item').last().before(lastItem); //如果只有5個頁籤

  if (rows <= 5) {
    for (var idx = 1; idx < rows - 1; idx++) {
      var aLink = $('<a/>', {
        class: 'page-link link-secondary',
        href: 'javascript:;',
        text: idx + 1
  ...
  function reRenderPages() {
    ...
    if (pageData.currentPage <= 4) {
      ...
      for (var _idx = 1; _idx < 4; _idx++) {
        ...
        $('.pagination').children().eq(_idx + 1).after(_item);
      }
    } else if (pageData.currentPage > 4 && pageData.currentPage < rows - 3) {
      $('.transition-item-js').show();
      var isRange = pageData.range.includes(pageData.currentPage); //判斷是否需重新渲染
      ...
      if (!isRange) {
        ...
        for (var _idx2 = 0; _idx2 < 3; _idx2++) {
          var _aLink2 = $('<a/>', {
            class: 'page-link link-secondary',
            href: 'javascript:;',
            text: pageData.currentPage + _idx2
          });
          ...
          $('.transition-item-js').eq(1).before(_item2);
        }

        $('.pages-js>a').each(function (idx, item) {
      ...
      for (var _idx3 = 3; _idx3 > 0; _idx3--) {
        ...
        $('.transition-item-js').eq(1).before(_item3);
      }
    }
  ...
  function renderCard() {
    var theme = JSON.parse(sessionStorage.getItem('theme'));
    var start = (pageData.currentPage - 1) * pageData.pageItems;
    var end = start + pageData.pageItems;
    var currentPageData = pageData.allData.slice(start, end);
    var str = (0, _createCard.createCard)(currentPageData, theme);
  ...
  function changeClass() {
    var select = $('.page-item').filter(function () {
...
},{"../asset/createCard":"js/asset/createCard.js","../asset/cardEvent":"js/asset/cardEvent.js"}],"js/components/scrollTop.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"js/searchPage.js":[function(require,module,exports) {
"use strict";
...
var _setBreadArray = require("./asset/setBreadArray");
...
var _pagination2 = _interopRequireDefault(require("../html/components/pagination.html"));
...
$(function () {
  ...
  $('#pagination').html(_pagination2.default);
  $('#scrollTop').html(_scrollTop2.default);
  $('.searchResult').html(_card.default);

  _header.default.init();

  _scrollTop.default.init();

  (0, _setBreadArray.setBreadArray)();
  var data = JSON.parse(sessionStorage.getItem('filterData')); //過濾沒有圖片的資料

  var filterData = (0, _createCard.filterCardData)(data);
  var num = filterData.length;
  var searchNum = $('<p/>', {
    class: 'me-auto ms-3 align-self-end'
  });
  searchNum.append("\u7E3D\u5171<span class=\"text-tertiary mx-1\">".concat(num, "</span>\u7B46"));
  $('.searchResult').find('.sectionTitle').text('收尋結果').after(searchNum);
  $('.searchResult').find('.moreLink').remove();
  (0, _pagination.renderPages)(filterData);

  _breadcrumb.default.init();

  _searchComponent.default.init(_getToken.default.getCookieToken());
});
},{"bootstrap/dist/js/bootstrap.bundle.min":"../node_modules/bootstrap/dist/js/bootstrap.bundle.min.js","./asset/getToken":"js/asset/getToken.js","./asset/setBreadArray":"js/asset/setBreadArray.js","./asset/createCard":"js/asset/createCard.js","./components/header":"js/components/header.js","./components/searchComponent":"js/components/searchComponent.js","./components/breadcrumb":"js/components/breadcrumb.js","./components/pagination":"js/components/pagination.js","./components/scrollTop":"js/components/scrollTop.js","../html/components/header.html":"html/components/header.html","../html/components/footer.html":"html/components/footer.html","../html/components/breadcrumb.html":"html/components/breadcrumb.html","../html/components/searchComponent.html":"html/components/searchComponent.html","../html/components/card.html":"html/components/card.html","../html/components/pagination.html":"html/components/pagination.html","../html/components/scrollTop.html":"html/components/scrollTop.html"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
var b=require("../node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("html",require("../node_modules/parcel-bundler/src/builtins/loaders/browser/html-loader.js"));b.load([["header.70c8671a.html","html/components/header.html"],["footer.a4fc5f39.html","html/components/footer.html"],["breadcrumb.d1992804.html","html/components/breadcrumb.html"],["searchComponent.fe3712b3.html","html/components/searchComponent.html"],["card.de535f08.html","html/components/card.html"],["pagination.d7a7258d.html","html/components/pagination.html"],["scrollTop.ebbedd64.html","html/components/scrollTop.html"]]).then(function(){require("js/searchPage.js");});
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js",0], null)
//# sourceMappingURL=/searchPage.20d50edc.js.map