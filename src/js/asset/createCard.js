  ...
  filterPicData.forEach((item) => {
    ...
    <div class="swiper-slide ">
      <div class="card h-100 bg-gray-100">
          <img class="object-fix" src="${item.Picture.PictureUrl1}" class="card-img-top" alt="...">
            <div class="card-body d-flex flex-column overflow-hidden">
              <p class="text-secondary mb-2">${times}</p>
              <h5 class="card-text">${item.ActivityName}</h5>
      ...
      <div class="col">
        <div class="card card-h ">
          <div class="card-imageContainer overflow-hidden">
            <img class="card-image object-fix "  src="${item.Picture.PictureUrl1}" class="card-img-top" alt="...">
          </div>
          <div class="card-body d-flex flex-column overflow-hidden">
