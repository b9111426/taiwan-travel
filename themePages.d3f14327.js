...
},{}],"js/asset/setBreadArray.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"qs":"../node_modules/qs/lib/index.js","axios":"../node_modules/axios/index.js","buffer":"../node_modules/buffer/index.js"}],"js/asset/location.js":[function(require,module,exports) {
"use strict";
...
},{"./location":"js/asset/location.js"}],"js/components/popularTopics.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  popularTopicsFn: function popularTopicsFn() {
    var theme = JSON.parse(sessionStorage.getItem('theme'));
    var themeList = {
      ScenicSpot: 'Class1',
      Activity: 'Class1',
    ...
    var option = themeList[theme];
    var str = (0, _createCard.createTopicClass)();
    $('.topics-container').html(str);
    $('.topics-container').find('.card').on('click', function () {
      var classes = $(this).find('.topics-title').text();
      var searchData = (0, _getData.filterData)(token, theme, '', option, classes);
      searchData.then(function (res) {
        sessionStorage.setItem('filterData', JSON.stringify(res.data));
        window.location.assign('./searchPage.html');
      });
...
exports.default = _default;
},{"../asset/createCard":"js/asset/createCard.js","../asset/getData":"js/asset/getData.js","../asset/getToken":"js/asset/getToken.js"}],"js/themePages.js":[function(require,module,exports) {
"use strict";
...
var _popularTopics = _interopRequireDefault(require("./components/popularTopics"));
...
var _popularTopics2 = _interopRequireDefault(require("../html/components/popularTopics.html"));
...
$(function () {
  ...
  $('#popularTopics').html(_popularTopics2.default);

  _header.default.init();

  (0, _setBreadArray.setBreadArray)();

  _popularTopics.default.init();

  _breadcrumb.default.init();

  _searchComponent.default.init();
});
},{"bootstrap/dist/js/bootstrap.bundle.min":"../node_modules/bootstrap/dist/js/bootstrap.bundle.min.js","./asset/setBreadArray":"js/asset/setBreadArray.js","./components/header":"js/components/header.js","./components/searchComponent":"js/components/searchComponent.js","./components/breadcrumb":"js/components/breadcrumb.js","./components/popularTopics":"js/components/popularTopics.js","../html/components/header.html":"html/components/header.html","../html/components/footer.html":"html/components/footer.html","../html/components/breadcrumb.html":"html/components/breadcrumb.html","../html/components/searchComponent.html":"html/components/searchComponent.html","../html/components/popularTopics.html":"html/components/popularTopics.html"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
var b=require("../node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("html",require("../node_modules/parcel-bundler/src/builtins/loaders/browser/html-loader.js"));b.load([["header.70c8671a.html","html/components/header.html"],["footer.a4fc5f39.html","html/components/footer.html"],["breadcrumb.d1992804.html","html/components/breadcrumb.html"],["searchComponent.fe3712b3.html","html/components/searchComponent.html"],["popularTopics.e334a42c.html","html/components/popularTopics.html"]]).then(function(){require("js/themePages.js");});
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js",0], null)
//# sourceMappingURL=/themePages.d3f14327.js.map